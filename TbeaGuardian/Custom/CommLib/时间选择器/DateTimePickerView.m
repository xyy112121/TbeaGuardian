...
// 获取RGB颜色
#define RGBA1(r,g,b,a) [UIColor colorWithRed:(r)/255.0f green:(g)/255.0f blue:(b)/255.0f alpha:a]
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        self.backgroundColor = RGBA1(0, 0, 0, 0.5);
        self.alpha = 0;
...
-(void)setCurrentDate:(NSDate *)currentDate
{
    ...
    NSCalendar *calendar0 = [[NSCalendar alloc] initWithCalendarIdentifier:NSCalendarIdentifierGregorian];
    NSDateComponents *comps = [[NSDateComponents alloc] init];
    NSInteger unitFlags =  NSCalendarUnitYear | NSCalendarUnitMonth | NSCalendarUnitDay | kCFCalendarUnitHour | NSCalendarUnitMinute;
