...
-(void)initwithtitle:(NSString *)str andmessage:(NSString *)str1 andcancelbtn:(NSString *)cancel andotherbtn:(NSString *)other
{
    ...
    CGSize size = [str boundingRectWithSize:CGSizeMake(self.frame.size.width-10, 9999999999999999) options:NSStringDrawingUsesLineFragmentOrigin attributes:attributes context:nil].size;
