...
#import "FDTimeChooser.h"
#import "Masonry.h"

@interface FDTimeChooser ()<UIGestureRecognizerDelegate>
{
    UIView *timeBroadcastView;
    FDCycleScrollView *yearScrollView;
    FDCycleScrollView *monthScrollView;
    FDCycleScrollView *dayScrollView;
    FDCycleScrollView *hourScrollView;
    FDCycleScrollView *minuteScrollView;
    FDCycleScrollView *secondScrollView;
...
- (void)setTimeBroadcastView {
    ...
    [_okBtn addTarget:self action:@selector(removeFDChooserTimerEvent:) forControlEvents:UIControlEventTouchUpInside];
    ...
    [_cancelBtn setBackgroundColor:[UIColor colorWithHexString:@"0x6271f3"]];
    [_cancelBtn setTitleColor:[UIColor colorWithHexString:@"0xffffff"] forState:UIControlStateNormal];
    [_cancelBtn setTitle:@"取消" forState:UIControlStateNormal];
    [_cancelBtn addTarget:self action:@selector(removeFDChooserTimerEvent:) forControlEvents:UIControlEventTouchUpInside];
    _cancelBtn.tag = kCancleBtnTag;
...
- (void)setYearScrollView{
    if (self.datePickerMode == DatePickerTimeMode) {
        yearScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(0, kTopViewHeight, kScreen_Width*0.25, kTimeBroadcastViewHeight)];
    }else if (self.datePickerMode == DatePickerDateMode){
        yearScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(0, kTopViewHeight, kScreen_Width*0.34, kTimeBroadcastViewHeight)];
    }else if (self.datePickerMode == DatePickerYearMonthMode){
        yearScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(0, kTopViewHeight, kScreen_Width*0.5, kTimeBroadcastViewHeight)];
    }else if (self.datePickerMode == DatePickerDateHourMinuteMode){
        yearScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(0, kTopViewHeight, kScreen_Width*0.28, kTimeBroadcastViewHeight)];
    }
...
- (void)setMonthScrollView{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        monthScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.25, kTopViewHeight, kScreen_Width*0.15, kTimeBroadcastViewHeight)];
    }
    else if (self.datePickerMode == DatePickerDateMode){
        monthScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.34, kTopViewHeight, kScreen_Width*0.33, kTimeBroadcastViewHeight)];
    }
    else if (self.datePickerMode == DatePickerMonthDayMode){
        monthScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0, kTopViewHeight, kScreen_Width*0.5, kTimeBroadcastViewHeight)];
    }
    else if (self.datePickerMode == DatePickerYearMonthMode){
        monthScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.5, kTopViewHeight, kScreen_Width*0.5, kTimeBroadcastViewHeight)];
    }
    else if (self.datePickerMode == DatePickerDateHourMinuteMode){
        monthScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.28, kTopViewHeight, kScreen_Width*0.18, kTimeBroadcastViewHeight)];
    }
...
- (void)setDayScrollView{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        dayScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.40, kTopViewHeight, kScreen_Width*0.15, kTimeBroadcastViewHeight)];
    }
    else if (self.datePickerMode == DatePickerDateMode){
        dayScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.67, kTopViewHeight, kScreen_Width*0.33, kTimeBroadcastViewHeight)];
    }
    else if (self.datePickerMode == DatePickerMonthDayMode){
        dayScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.5, kTopViewHeight, kScreen_Width*0.5, kTimeBroadcastViewHeight)];
    }
    else if (self.datePickerMode == DatePickerDateHourMinuteMode){
        dayScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.46, kTopViewHeight, kScreen_Width*0.18, kTimeBroadcastViewHeight)];
    }
...
- (void)setHourScrollView{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        hourScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.55, kTopViewHeight, kScreen_Width*0.15, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerTimeMode) {
        hourScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(0, kTopViewHeight, kScreen_Width*0.34, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerHourMinuteMode) {
        hourScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(0, kTopViewHeight, kScreen_Width*0.5, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerDateHourMinuteMode) {
        hourScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.64, kTopViewHeight, kScreen_Width*0.18, kTimeBroadcastViewHeight)];
    }
...
- (void)setMinuteScrollView{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        minuteScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.70, kTopViewHeight, kScreen_Width*0.15, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerTimeMode) {
        minuteScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.34, kTopViewHeight, kScreen_Width*0.33, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerHourMinuteMode) {
        minuteScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.5, kTopViewHeight, kScreen_Width*0.5, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerDateHourMinuteMode) {
        minuteScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.82, kTopViewHeight, kScreen_Width*0.18, kTimeBroadcastViewHeight)];
    }
    self.curMin  = [self setNowTimeShow:3];
...
- (void)setSecondScrollView{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        secondScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.85, kTopViewHeight, kScreen_Width*0.15, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerTimeMode) {
        secondScrollView = [[FDCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.67, kTopViewHeight, kScreen_Width*0.33, kTimeBroadcastViewHeight)];
    }
...
- (void)setAfterScrollShowView:(FDCycleScrollView*)scrollview  andCurrentPage:(NSInteger)pageNumber{
...
#pragma mark FDcyclescrollview delegate
#pragma mark FDcyclescrollview databasesource
...
- (void)removeFDChooserTimerEvent:(UIButton *)selectedButton{
    typeof(self) __weak weak = self;
    [self dismissBlock:^(BOOL Complete) {
        if (selectedButton.tag == kOKBtnTag) {
            ...
            switch (self.datePickerMode) {
                case DatePickerDateMode:
                    dateTimeStr = [NSString stringWithFormat:@"%ld年%ld月%ld日",(long)self.curYear,(long)self.curMonth,(long)self.curDay];
                    break;
            ...
            [self.fdDelegate timeChooser:self didSelectTimeString:dateTimeStr];
        } else {
...
@implementation UIColor (FDTimeChooser)
...
- (void)setDataource:(id<FDCycleScrollViewDataSource>)datasource{
...
- (void)loadData{
    ...
    for (int i = 0; i < 7; i++) {
        ...
        view.frame = CGRectOffset(view.frame, 0, view.frame.size.height * i );
