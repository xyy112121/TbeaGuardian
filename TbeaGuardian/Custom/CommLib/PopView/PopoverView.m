...
#define RGB2(r, g, b)    [UIColor colorWithRed:(r)/255.f green:(g)/255.f blue:(b)/255.f alpha:1.f]
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        // Initialization code
        self.borderColor = RGB2(200, 199, 204);
...
-(CGRect)getViewFrame
{
    ...
    for (NSString *title in self.titleArray) {
        ...
        NSDictionary *attributes = @{ NSFontAttributeName : TITLE_FONT, NSParagraphStyleAttributeName : style };
        
        
        CGSize Sizetemp = [title boundingRectWithSize:CGSizeMake(300, 100) options:NSStringDrawingUsesLineFragmentOrigin attributes:attributes context:nil].size;
        
        CGFloat width =  Sizetemp.width;//[title sizeWithFont:TITLE_FONT constrainedToSize:CGSizeMake(300, 100) lineBreakMode:NSLineBreakByCharWrapping].width;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.backgroundView.backgroundColor = RGB2(245, 245, 245);
