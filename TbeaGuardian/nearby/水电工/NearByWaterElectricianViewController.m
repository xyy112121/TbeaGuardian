//
//  NearByWaterElectricianViewController.m
//  TbeaGuardian
//
...
#import "NearByWaterElectricianViewController.h"

@interface NearByWaterElectricianViewController ()

@end

@implementation NearByWaterElectricianViewController
...
-(void)initview
{
    ...
    tableview.mj_header = [MJRefreshNormalHeader headerWithRefreshingBlock:^{
        [weakSelf getwatereleclist:@"1" PageSize:@"10"];
    }];
    
    tableview.mj_footer = [MJRefreshBackNormalFooter footerWithRefreshingBlock:^{
        [weakSelf getwatereleclist:@"1" PageSize:[NSString stringWithFormat:@"%d",(int)[FCarraydata count]+10]];
    ...
    [self getwatereleclist:@"1" PageSize:@"10"];
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    SearchNavigateView *navi = [[SearchNavigateView alloc] initWithFrame:CGRectMake(50,0, SCREEN_WIDTH-50, 44) FromFlag:@"3"]; //传2表示是商品列表页
...
#pragma mark 接口
-(void)getwatereleclist:(NSString *)page PageSize:(NSString *)pagesize
{
    ...
    [RequestInterface doGetJsonWithParametersNoAn:params App:app RequestCode:RQNearByWaterElectricianCode ReqUrl:InterfaceRequestUrl ShowView:app.window alwaysdo:^{
