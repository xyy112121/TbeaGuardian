//
//  MyDetectDetailYiPaiDanViewController.m
//  TbeaGuardian
//
...
#import "MyDetectDetailYiPaiDanViewController.h"

@interface MyDetectDetailYiPaiDanViewController ()

@end

@implementation MyDetectDetailYiPaiDanViewController
...
-(void)footerview
{
    ...
    [button addTarget:self action:@selector(clickdonedetect:) forControlEvents:UIControlEventTouchUpInside];
...
-(void)clickdonedetect:(id)sender
{
    [self getdonedetect];
}
...
-(void)getdonedetect
{
    ...
    [RequestInterface doGetJsonWithParametersNoAn:params App:app RequestCode:RQMyDetectDoneOverServiceCode ReqUrl:InterfaceRequestUrl ShowView:app.window alwaysdo:^{
...
-(void)getdetectdetail
{
    ...
    [RequestInterface doGetJsonWithParametersNoAn:params App:app RequestCode:RQMyDetectYiPaiDanDetailCode ReqUrl:InterfaceRequestUrl ShowView:app.window alwaysdo:^{
        ...
        if([[dic objectForKey:@"success"] isEqualToString:@"true"])
        {
            ...
            FCassigntime =  [[[dic objectForKey:@"data"] objectForKey:@"assigninfo"] objectForKey:@"assigntime"];
