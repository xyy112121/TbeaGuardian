//
//  MyPageModifyPhoneNewViewController.m
//  TbeaCloudBusiness
//
...
#import "MyPageModifyPhoneNewViewController.h"

@interface MyPageModifyPhoneNewViewController ()

@end

@implementation MyPageModifyPhoneNewViewController
...
-(void)initfootview
{
	...
	[btnext addTarget:self action:@selector(gotodone:) forControlEvents:UIControlEventTouchUpInside];
...
{
	MyPageModifyPhoneDoneViewController *mypage = [[MyPageModifyPhoneDoneViewController alloc] init];
