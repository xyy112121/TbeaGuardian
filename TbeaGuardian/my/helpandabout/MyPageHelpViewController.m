...
#import "MyPageHelpViewController.h"

@interface MyPageHelpViewController ()

@end

@implementation MyPageHelpViewController
...
- (void)webView:(WKWebView *)webView didFinishNavigation:(WKNavigation *)navigation
{
    ...
    __block MyPageHelpViewController *weakSelf = self;
