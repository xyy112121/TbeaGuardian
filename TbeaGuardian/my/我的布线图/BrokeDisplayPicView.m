...
-(id)initWithFrame:(CGRect)frame PicPath:(NSString *)picpath  FromImage:(UIImage *)fromimage
{
	...
	if (self)
	{
		...
		[self initview:@"https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1505717229682&di=0da8ddf9991f862e23527d56a264ae00&imgtype=0&src=http%3A%2F%2Fmingxing.dabaoku.com%2Fdalunv%2Fjinqiaoqiao%2F064cl.jpg" FromImage:fromimage];
